            ...
            <div className="col-md-6 d-flex align-items-center">
              <div className="text px-4 pt-5 pt-md-0 px-md-4 pr-md-5 ftco-animate">
                ...
                <p>
                  ...
                  blog, where I will be getting a change to explore my creative
                  side, while developing my a techical skills. I made this blog
                  using ReactJS on the front-end, and a MongoDB Stitch app for
                  the back-end. I hope that you enjoy!
                </p>
              </div>
            </div>
          </div>
